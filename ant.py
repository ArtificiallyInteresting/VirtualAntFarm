...
from util import *
class Ant:
    def __init__(self, boardWidth, boardHeight, knowledge, x=2, y=2):
        self.x = x
        self.y = y
    ...
    def updateKnowledge(self, selectionArgs):
        ...
        for key in antBoard.keys():
            ...
            if antBoard[key] == State.COLONY and self.knowledge["enemyColony"] == [] and self.knowledge["homeColony"] != key.split(","):
